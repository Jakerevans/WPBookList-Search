...
jQuery( document ).ready( function( $ ) {
	...
	function wpbooklistSearchPluginPageDashboardSaveKey() {
		...
		$( '#wpbooklist-extension-genreric-key-dashboard-form-search' ).on( 'submit', function( event ) {

			var picker = $( this ).find( '.wpbooklist-extension-genreric-key-dashboard-input' ).val();

			// Make Ajax call to get display options.
			var data = {
				'action': 'wpbooklist_search_save_review_key_action',
		...
		$( '#wpbooklist-extension-genreric-key-plugins-page-button-search' ).on( 'click', function( event ) {
