...
jQuery( document ).ready( function( $ ) {
	...
	function wpbooklistSearchPluginPageDashboardSaveKey() {
		...
		$( '#wpbooklist-extension-genreric-key-dashboard-form-search' ).on( 'submit', function() {

			var license = $( '#wpbooklist-extension-genreric-key-dashboard-input-search' ).val();
		...
		$( '#wpbooklist-extension-genreric-key-plugins-page-button-search' ).on( 'click', function() {
