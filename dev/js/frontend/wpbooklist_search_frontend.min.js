...
jQuery( document ).ready( function( $ ) {
	...
	function wpbooklistSearchPopulate(){
		...
		if ( -1 < window.location.href.indexOf( 'searchby' ) && -1 < window.location.href.indexOf( 'searchterm' ) && -1 < window.location.href.indexOf( 'querytable' ) ) {
			...
			if ( 'undefined' !== params.searchterm ) {
			...
			if ( -1 < filtertermsarray.indexOf( 'rating' ) ) {
				 for (var i=0; i<filtertermsarray.length; i++) {
			        if (filtertermsarray[i] === 'rating' ) {                
			            $('#wpbooklist-search-refineby-rating').val( filtervaluesarray[i] );
			        }
			    }
			}

			// Populate the format.
			if ( -1 < filtertermsarray.indexOf( 'format' ) ) {
				 for (var i=0; i<filtertermsarray.length; i++) {
			        if (filtertermsarray[i] === 'format' ) {     
			            $('#wpbooklist-search-refineby-format').val( filtervaluesarray[i] );
			        }
			    }
			}

			// Populate the format.
			if ( -1 < filtertermsarray.indexOf( 'language' ) ) {
				 for (var i=0; i<filtertermsarray.length; i++) {
			        if (filtertermsarray[i] === 'language' ) {     
			            $('#wpbooklist-search-refineby-language').val( filtervaluesarray[i] );
			        }
			    }
			}

			// Populate the genre.
			if ( -1 < filtertermsarray.indexOf( 'genres' ) ) {
				 for (var i=0; i<filtertermsarray.length; i++) {
			        if (filtertermsarray[i] === 'genres' ) {     
			            $('#wpbooklist-search-refineby-genre').val( filtervaluesarray[i] );
			        }
			    }
			}

			// Populate the genre.
			if ( -1 < filtertermsarray.indexOf( 'subgenre' ) ) {
				 for (var i=0; i<filtertermsarray.length; i++) {
			        if (filtertermsarray[i] === 'subgenre' ) {     
			            $('#wpbooklist-search-refineby-subgenre').val( filtervaluesarray[i] );
			        }
			    }
			}
			...
			if ( ( -1 < filtertermsarray.indexOf( 'pub_year_' + wpbooklistPhpVariables.trans661 ) ) || ( -1 < filtertermsarray.indexOf( 'pub_year_' + wpbooklistPhpVariables.trans662 ) ) || ( -1 < filtertermsarray.indexOf( 'pub_year_' + wpbooklistPhpVariables.trans663 ) )    ) {

				 console.log('in2!'); 

				 for (var i=0; i<filtertermsarray.length; i++) {
			        if (  -1 <  filtertermsarray[i].indexOf( 'pub_year_' ) ) {    

			        console.log('in!'); 

			        	tempPubWord = filtertermsarray[i].split( '_' ); 

			            $('#wpbooklist-search-refineby-pubyear-word').val( tempPubWord[2] )
			            $('#wpbooklist-search-refineby-pubyear-year').val( filtervaluesarray[i] )
			        }
			    }
			}
	...
	function wpbooklistSearchRefiningSubmit(){
		...
		$( '#wpbooklist-search-searchterm-refined-form' ).on( 'submit', function() {
			...
			var filterformatvalue = '';
			var filtergenrevalue = '';
			var filtersubgenrevalue = '';
			var filterpubyearvalue = '';
			var filterlanguagevalue = '';
			var $tempTerm = '';
			...
			filterformatvalue = $( '#wpbooklist-search-refineby-format' ).val();
			if ( null !== filterformatvalue ) {
				endfilterterms = endfilterterms + ',format';
				endfiltervalues = endfiltervalues + ',' + filterformatvalue;
			}

			filterpubyearvalue = $( '#wpbooklist-search-refineby-pubyear-year' ).val();
			if ( null !== filterpubyearvalue ) {
				$tempTerm = $( '#wpbooklist-search-refineby-pubyear-word' ).val();
				endfilterterms = endfilterterms + ',pub_year_' + $tempTerm;
				endfiltervalues = endfiltervalues + ',' + filterpubyearvalue;
			}

			filterlanguagevalue = $( '#wpbooklist-search-refineby-language' ).val();
			if ( null !== filterlanguagevalue && '' !== filterlanguagevalue ) {
				endfilterterms = endfilterterms + ',language';
				endfiltervalues = endfiltervalues + ',' + filterlanguagevalue;
			}


			filtergenrevalue = $( '#wpbooklist-search-refineby-genre' ).val();
			if ( null !== filtergenrevalue && '' !== filtergenrevalue ) {
				endfilterterms = endfilterterms + ',genres';
				endfiltervalues = endfiltervalues + ',' + filtergenrevalue;
			}

			filtersubgenrevalue = $( '#wpbooklist-search-refineby-subgenre' ).val();
			if ( null !== filtersubgenrevalue && '' !== filtersubgenrevalue ) {
				endfilterterms = endfilterterms + ',subgenre';
				endfiltervalues = endfiltervalues + ',' + filtersubgenrevalue;
			}
