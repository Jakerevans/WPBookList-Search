...
if ( ! class_exists( 'WPBookList_Search', false ) ) :
	...
	class WPBookList_Search {
		...
		public function __construct() {
			...
			require_once SEARCH_CLASS_DIR . 'class-wpbooklist-search-fields-form.php';
			...
			$this->form     = new WPBookList_Search_Fields_Form();
		...
		private function output_open_admin_container() {
			$title    = $this->trans->trans_638;
			$icon_url = SEARCH_ROOT_IMG_URL . 'booksearch.svg';
