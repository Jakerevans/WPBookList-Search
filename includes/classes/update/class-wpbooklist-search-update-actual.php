<?php
/**
 * WPBookList WPBookList_Search_Update_Actual Class
 *
 * @author   Jake Evans
 * @category admin
...
if ( ! class_exists( 'WPBookList_Search_Update_Actual', false ) ) :
	/**
	 * WPBookList_Search_Update_Actual Class.
	 */
	class WPBookList_Search_Update_Actual {
		...
		public function __construct( $_api_url, $_plugin_file, $_api_data = null ) {
			...
			if ( $test_name === $wpdb->get_var( "SHOW TABLES LIKE '$test_name'" ) ) {
				 ...
				 */
				do_action( 'post_edd_sl_plugin_updater_search_setup', $edd_plugin_data );
